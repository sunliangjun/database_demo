...
class ChatAdminRights(TLObject):  # type: ignore
    ...
    __slots__: List[str] = ["change_info", "post_messages", "edit_messages", "delete_messages", "ban_users", "invite_users", "pin_messages", "add_admins"]

    ID = 0x5fb224d5
    QUALNAME = "types.ChatAdminRights"

    def __init__(self, *, change_info: Union[None, bool] = None, post_messages: Union[None, bool] = None, edit_messages: Union[None, bool] = None, delete_messages: Union[None, bool] = None, ban_users: Union[None, bool] = None, invite_users: Union[None, bool] = None, pin_messages: Union[None, bool] = None, add_admins: Union[None, bool] = None) -> None:
