...
class Message(TLObject):  # type: ignore
    ...
    __slots__: List[str] = ["id", "to_id", "date", "message", "out", "mentioned", "media_unread", "silent", "post", "from_scheduled", "legacy", "edit_hide", "from_id", "fwd_from", "via_bot_id", "reply_to_msg_id", "media", "reply_markup", "entities", "views", "edit_date", "post_author", "grouped_id", "restriction_reason"]

    ID = 0x452c0e65
    QUALNAME = "types.Message"

    def __init__(self, *, id: int, to_id: "raw.base.Peer", date: int, message: str, out: Union[None, bool] = None, mentioned: Union[None, bool] = None, media_unread: Union[None, bool] = None, silent: Union[None, bool] = None, post: Union[None, bool] = None, from_scheduled: Union[None, bool] = None, legacy: Union[None, bool] = None, edit_hide: Union[None, bool] = None, from_id: Union[None, int] = None, fwd_from: "raw.base.MessageFwdHeader" = None, via_bot_id: Union[None, int] = None, reply_to_msg_id: Union[None, int] = None, media: "raw.base.MessageMedia" = None, reply_markup: "raw.base.ReplyMarkup" = None, entities: Union[None, List["raw.base.MessageEntity"]] = None, views: Union[None, int] = None, edit_date: Union[None, int] = None, post_author: Union[None, str] = None, grouped_id: Union[None, int] = None, restriction_reason: Union[None, List["raw.base.RestrictionReason"]] = None) -> None:
        self.id = id  # int
