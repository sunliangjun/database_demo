...
class MessageFwdHeader(TLObject):  # type: ignore
    ...
    __slots__: List[str] = ["date", "from_id", "from_name", "channel_id", "channel_post", "post_author", "saved_from_peer", "saved_from_msg_id", "psa_type"]

    ID = 0x353a686b
    QUALNAME = "types.MessageFwdHeader"

    def __init__(self, *, date: int, from_id: Union[None, int] = None, from_name: Union[None, str] = None, channel_id: Union[None, int] = None, channel_post: Union[None, int] = None, post_author: Union[None, str] = None, saved_from_peer: "raw.base.Peer" = None, saved_from_msg_id: Union[None, int] = None, psa_type: Union[None, str] = None) -> None:
        self.date = date  # int
