...
class ForwardMessages(TLObject):  # type: ignore
    ...
    __slots__: List[str] = ["from_peer", "id", "random_id", "to_peer", "silent", "background", "with_my_score", "grouped", "schedule_date"]

    ID = 0xd9fee60e
    QUALNAME = "functions.messages.ForwardMessages"

    def __init__(self, *, from_peer: "raw.base.InputPeer", id: List[int], random_id: List[int], to_peer: "raw.base.InputPeer", silent: Union[None, bool] = None, background: Union[None, bool] = None, with_my_score: Union[None, bool] = None, grouped: Union[None, bool] = None, schedule_date: Union[None, int] = None) -> None:
